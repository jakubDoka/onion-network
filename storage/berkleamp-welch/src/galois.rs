...
#[cfg(all(
    any(all(target_feature = "ssse3", not(target_feature = "avx2")), target_feature = "simd128"),
    feature = "simd"
))]
const LANES: usize = 16;

#[cfg(all(
    any(target_feature = "avx2", target_feature = "ssse3", target_feature = "simd128"),
    feature = "simd"
))]
...
#[cfg(any(
    not(any(target_feature = "avx2", target_feature = "ssse3", target_feature = "simd128",)),
    not(feature = "simd")
))]
pub fn mul_slice_xor(c: u8, input: &[u8], out: &mut [u8]) {
